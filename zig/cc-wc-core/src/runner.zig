...
fn processStdin(allocator: std.mem.Allocator, flags: arguments.FlagSet) u8 {
...
fn processFiles(allocator: std.mem.Allocator, flags: arguments.FlagSet, filepaths: []const []const u8) u8 {
    var status: u8 = 0;
...
fn processFile(allocator: std.mem.Allocator, flags: arguments.FlagSet, filepath: []const u8, status: *u8) void {
